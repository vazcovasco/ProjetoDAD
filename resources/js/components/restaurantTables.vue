<template>
	<div>
		...
		<router-link to="/restaurantTables/add"> <button>Add a table</button>  </router-link>

		<tables-list :restaurant_tables="restaurant_tables" @edit-table-click="editTable" @show-restaurant-table-click="showTable" @delete-click="deleteTable" @restore-table-click="restoreTable" ref="restaurantTablesListRef"> </tables-list>
